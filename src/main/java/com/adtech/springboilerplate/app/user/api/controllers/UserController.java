package com.adtech.springboilerplate.app.user.api.controllers;
...
import com.adtech.springboilerplate.app.user.usecases.CreateUserUseCase;
...
public class UserController {
	...
	public @ResponseBody ResponseEntity<UserEntity> create(
		...
		try {
			UserEntity user = this.createUserUseCase.execute(data);
