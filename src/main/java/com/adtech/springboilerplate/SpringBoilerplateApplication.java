...
@EnableJpaRepositories("com.adtech.springboilerplate.core.infra.database.repositories")
@EnableKafka
public class SpringBoilerplateApplication implements ApplicationRunner {
	...
	public static void main(String[] args) {
		try {
			...
			System.out.println("SpringBoilerplateApplication.Error → " + error.getMessage());
			error.printStackTrace();
			System.exit(0);
		} catch (Exception exception) {
			System.out.println("SpringBoilerplateApplication.Exception → " + exception.getMessage());
